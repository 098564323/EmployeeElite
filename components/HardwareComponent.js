...
export default class HardwareComponent extends Component {
    ...
    render() {
		...
		<View style={{
		  ...
		  <StatusBar
                ...
                />
            <HeaderComponent title="Hardware Availablity" {...this.props} />
 <ScrollView>
            <View style={{
                flex: 1,
                backgroundColor: '#ffffff',
         ...
         Select your hardware requirements
        </Text>
        ...
        <Picker.Item label="System upgradation" value="System upgradation" />
        <Picker.Item label="Network related" value="Network related" />
