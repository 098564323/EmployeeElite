        ...
        return (
          ...
          <View style={styles.container }>
			...
			<CardView
              ...
              <Text style={styles.textDescription2}>{this.props.item.venue}</Text>
...
export default class EventListComponent extends Component {
    ...
    this.data = [
      [{time: '18 Jul 2018', title: 'Being Proactive', description: 'Devang Mehta',venue:'3:30 PM'},{time: '18 Jul 2018', title: 'Being Proactive', description: 'Devang Mehta',venue:'3:30 PM'}],
      [{time: '18 Jul 2018', title: 'Being Proactive', description: 'Devang Mehta',venue:'3:30 PM'}],
      [{time: '18 Jul 2018', title: 'Being Proactive', description: 'Devang Mehta',venue:'3:30 PM'}],
      [{time: '18 Jul 2018', title: 'Being Proactive', description: 'Devang Mehta',venue:'3:30 PM'},{time: '18 Jul 2018', title: 'Being Proactive', description: 'Devang Mehta',venue:'3:30 PM'},{time: '18 Jul 2018', title: 'Being Proactive', description: 'Devang Mehta',venue:'3:30 PM'}],
      [{time: '18 Jul 2018', title: 'Being Proactive', description: 'Devang Mehta',venue:'3:30 PM'}]
    ]
  }
    ...
    render() {
        return (<View style={{
		 ...
		 <StatusBar
                ...
                />
            <HeaderComponent title="SessionList" rightIcon="" {...this.props}
								/>
            ...
            <View style={{
			  ...
			  <Text style={styles.textTitle}>Upcoming Sessions</Text>
